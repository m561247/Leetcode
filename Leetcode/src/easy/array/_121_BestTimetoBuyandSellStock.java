...
public class _121_BestTimetoBuyandSellStock {
	/*
	 * Solution_1 : Kadane's Algorithm，這問題類似 max subarray problem
	 */
	public int maxProfit_Sol_1(int[] prices) { // [7,1,5,3,6,4] [7,6,4,3,1] 
	 ...
	 */
	public static int maxProfit_Sol_2(int[] prices) {
		int maxprofit = 0;
	 ...
	 * Solution_3 : one pass
	 */
	public static int maxProfit_Sol_3(int[] prices) {
